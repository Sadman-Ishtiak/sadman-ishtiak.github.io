...
According to the requirements, we need to create a database first, 
```sql
...
The shell command to import this data into a PostgreSQL database named `worldcup` with a table named `games` is:
```bash
#! /bin/bash
