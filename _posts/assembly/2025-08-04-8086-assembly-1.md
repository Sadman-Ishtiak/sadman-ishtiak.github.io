...
<table width='100%'>
  ...
  <tbody>
    <tr>
      <td>`.model tiny`</td>
      <td>Code + data fit in 1 segment (COM programs)</td>
    </tr>
    <tr>
      <td>`.model small`</td>
      <td>Code and data each have <b>one</b> segment</td>
    </tr>
    <tr>
      <td>`.model medium`</td>
      <td>Code can span <b>multiple</b> segments, data in one</td>
    </tr>
    <tr>
      <td>`.model large`</td>
      <td>Code and data both can be in <b>multiple</b> segments</td>
    </tr>
  </tbody>
</table>
